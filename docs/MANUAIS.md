...
| Toyota | A pagina abre, mas o servidor dos PDFs devolve 403 |
...
- `_fora_do_catalogo/` — documentos de modelos que nao estao no catalogo do
  agente. Indexá-los faria o agente responder sobre carros que ele nao tem —
  o que e justamente o erro que o projeto evita.
...
responder em profundidade sobre esses dois e nao vai responder nada sobre os
outros 26. Isso parece falha para quem usa. Se for incluir poucos manuais, vale
...
mantê-los fora do repositorio evita redistribuí-los. Quem clonar o projeto
